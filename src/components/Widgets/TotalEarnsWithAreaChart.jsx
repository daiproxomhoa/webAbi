      ...
      <Fragment>
        <div className='chart-top total-earn-chart d-flex justify-content-between mb-50'>
          <div className='d-flex align-items-end'>
            <span className='badge-primary badge-sm'>&nbsp;</span>
            <span className='fs-12'>Sales</span>
            <span className='badge-warning badge-sm'>&nbsp;</span>
            <span className='fs-12'>Visitors</span>
          </div>
        ...
        <StackedAreaChart labels={labels} datasets={datasets} />
      </Fragment>
    )
  }
}
